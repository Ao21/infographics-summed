...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/7de6c3dd94feaeb21f20054b9f30d5dabc5efabd/d3/d3.d.ts
...
declare namespace d3 {
    ...
    namespace layout {
        ...
        export interface Partition<T extends partition.Node> {
            ...
            children(value: (node: T) => number): Partition<T>;
            children(): (node: T, depth: number) => T[];
