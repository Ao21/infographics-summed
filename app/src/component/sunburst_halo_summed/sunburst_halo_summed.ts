...
export class SunburstHaloSummed {
	...
	constructor() {
		...
		if (!this.options) {
			this.options = { "year": 2016,"country": "denmark", "graph": "sunburstProjection", "translations": { "totalContributions": "Totale bidrag til", "unhcr": "Totale bidrag til UNHCR", "contributions": "Sist opdateret", "comprises": "Udgør <span class=\"percentage\"></span> af", "total": "<span>Totale</span> bidrag til <span class=\"country_name\"></span>", "countryName": "testland" }
		};
	}
...
prepData(currencyType ?: any) {
	...
	if (this.options && this.options.hasOwnProperty('year')) {
		this.info.setYear(this.options.year);
